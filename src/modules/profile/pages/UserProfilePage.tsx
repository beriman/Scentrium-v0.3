  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto py-4 md:py-8 px-4">
        {/* Cover Photo */}
        <div className="relative rounded-xl overflow-hidden mb-16 h-40 md:h-64">
          <img
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
          ...
          <div className="lg:col-span-2">
            <Tabs defaultValue="activity">
                  ...
                  <CardContent className="p-4 md:p-6 pt-0">
                    <div className="space-y-4 md:space-y-6">
                      {userData.activities.map((activity, index) => (
                        <div
                          key={index}
                          className="flex items-start gap-3 md:gap-4 pb-4 border-b last:border-0 last:pb-0"
                        >
              ...
              <TabsContent value="upgrade" className="mt-4 md:mt-6">
                <Card>
                  <CardHeader className="p-4 md:p-6">
                  ...
                  <CardContent className="p-4 md:p-6 pt-0">
                    <div className="overflow-x-auto -mx-4 md:mx-0">
                      <div className="min-w-[600px] md:min-w-0 px-4 md:px-0">
                        <table className="w-full border-collapse">
                          ...
                          <tbody>
                            {userData.membershipComparison.map(
                              (item, index) => (
                                <tr
                                  key={index}
                    ...
                    <div className="mt-6 md:mt-8 bg-purple-50 rounded-lg p-4 md:p-6 text-center">
                      <div className="flex justify-center mb-4">
                        <div className="bg-purple-100 p-3 rounded-full">
                          <Crown className="h-6 md:h-8 w-6 md:w-8 text-purple-700" />
                        </div>
                      </div>
